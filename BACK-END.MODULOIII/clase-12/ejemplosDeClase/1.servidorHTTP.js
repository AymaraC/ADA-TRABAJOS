// Importamos el modulo http de Node.js, que nos va a permitir crear un servidor
...
const server = http.createServer((req, res) => {
    ...
    // Congifuramos el encabezado con 'Content-type' para que el cliente sepa que el contenido es texto plano
