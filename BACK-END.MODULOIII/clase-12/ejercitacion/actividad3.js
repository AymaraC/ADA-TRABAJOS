...
Consigna: En este ejercicio, vamos a permitir que el cliente busque información de un usuario por su ID. Crea un 
endpoint GET que reciba un parámetro dinámico :id en la URL (por ejemplo, /users/1). Usa req.params para capturar
...
const users = [
    {id: 1, name: 'Ada Lovelace', mail: 'ada@example.com'},
    {id: 2, name: 'Grace Hopper', mail: 'grace@example.com'}
];

// Creamos un endpoint GET para buscar usuarios por id
app.get('/users/:id', (req, res) => {
    // capturar el parametro dinamico
    const {id} = req.params     // De los parametros que tenemos solo sacamos el id
