...
Exporta esta función como exportación por defecto. En main.ts, importa createMultiplier, crea un multiplicador (por ejemplo, para multiplicar 
por 2) y utiliza la función devuelta para multiplicar un número y mostrar el resultado en la consola.*/
